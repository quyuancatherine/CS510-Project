...
00000100 <ls>:
{
 ...
 11c:	78 52                	js     170 <ls+0x70>
  if(fstat(fd, &st) < 0){
 11e:	8d b5 d0 fd ff ff    	lea    -0x230(%ebp),%esi
 ...
 193:	8b 95 e0 fd ff ff    	mov    -0x220(%ebp),%edx
 199:	8b b5 d8 fd ff ff    	mov    -0x228(%ebp),%esi
 19f:	57                   	push   %edi
 ...
 259:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 260:	8d 85 c0 fd ff ff    	lea    -0x240(%ebp),%eax
 ...
 278:	0f 85 d4 fe ff ff    	jne    152 <ls+0x52>
      if(de.inum == 0)
 27e:	66 83 bd c0 fd ff ff 	cmpw   $0x0,-0x240(%ebp)
 285:	00 
 286:	74 d8                	je     260 <ls+0x160>
      memmove(p, de.name, DIRSIZ);
 288:	8d 85 c2 fd ff ff    	lea    -0x23e(%ebp),%eax
 ...
 2b9:	0f bf 85 d0 fd ff ff 	movswl -0x230(%ebp),%eax
 2c0:	83 ec 0c             	sub    $0xc,%esp
 2c3:	8b 8d e0 fd ff ff    	mov    -0x220(%ebp),%ecx
 2c9:	8b 95 d8 fd ff ff    	mov    -0x228(%ebp),%edx
 2cf:	57                   	push   %edi
