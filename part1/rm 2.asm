...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    102e:	e8 53 02 00 00       	call   1286 <unlink>
  ...
  for(i = 1; i < argc; i++){
    ...
    1062:	68 9c 16 00 00       	push   $0x169c
    1067:	6a 02                	push   $0x2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1320:	f7 f1                	div    %ecx
    1322:	0f b6 92 bc 16 00 00 	movzbl 0x16bc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    14aa:	e9 06 ff ff ff       	jmp    13b5 <printf+0x45>
          s = "(null)";
    14af:	bb b5 16 00 00       	mov    $0x16b5,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    154c:	a1 30 19 00 00       	mov    0x1930,%eax
    ...
    155b:	77 10                	ja     156d <free+0x2d>
{
  ...
  freep = p;
    1588:	a3 30 19 00 00       	mov    %eax,0x1930
}
    158d:	5b                   	pop    %ebx
    158e:	5e                   	pop    %esi
    158f:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    15c3:	8b 15 30 19 00 00    	mov    0x1930,%edx
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    base.s.ptr = freep = prevp = &base;
    15ed:	c7 05 30 19 00 00 34 	movl   $0x1934,0x1930
    15f4:	19 00 00 
    15f7:	c7 05 34 19 00 00 34 	movl   $0x1934,0x1934
    15fe:	19 00 00 
    base.s.size = 0;
    1601:	c7 05 38 19 00 00 00 	movl   $0x0,0x1938
    1608:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    160b:	ba 34 19 00 00       	mov    $0x1934,%edx
    ...
    161e:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    1621:	89 15 30 19 00 00    	mov    %edx,0x1930
      return (void*)(p + 1);
  ...
  return freep;
    1647:	8b 15 30 19 00 00    	mov    0x1930,%edx
      if((p = morecore(nunits)) == 0)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    165f:	39 05 30 19 00 00    	cmp    %eax,0x1930
